...
const PROVIDER_LIST: ProviderInfo[] = [
  ...
  },
  {
    name: 'AmazonBedrock',
    staticModels: [
      { name: 'us.meta.llama3-2-90b-instruct-v1:0', label: 'Llama 3.2 90b AWS', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'us.meta.llama3-2-11b-instruct-v1:0', label: 'Llama 3.2 11b AWS', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'us.anthropic.claude-3-5-sonnet-20241022-v2:0', label: 'Claude 3.5 Sonnet v2', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'anthropic.claude-3-5-sonnet-20240620-v1:0', label: 'Claude 3.5 Sonnet v1', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'us.anthropic.claude-3-5-haiku-20241022-v1:0', label: 'Claude 3.5 Haiku', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'amazon.nova-pro-v1:0', label: 'Nova Pro', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
      { name: 'amazon.nova-lite-v1:0', label: 'Nova Lite', provider: 'AmazonBedrock', maxTokenAllowed: 8000 },
    ],
